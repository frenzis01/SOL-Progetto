...
VALGRINDO=valgrind --leak-check=full -s --track-origins=yes --show-leak-kinds=all
...
bin/client -h -f sock -t 100 -p -E test/evicted -w mock/1,n=2 -W mock/1/3,mock/2/8 -D test/evicted -r mock/1/3,mock/2/8 -d test/read -R -d test/read -w mock -l mock/2/5,mock/2/6 -u mock/2/6 -c mock/2/5
